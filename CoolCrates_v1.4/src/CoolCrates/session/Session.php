...
class Session {
     ...
     * @return int
     */
    public function getCrateKey($identifier){
     ...
     * @return bool
     */
    public function hasCrateKey($identifier) {
     ...
     * @param int $amount
     */
    public function addCrateKey($identifier, $amount = 1) {
     ...
     * @param int $amount
     */
    public function removeCrateKey($identifier, $amount = 1) {
     ...
     * @param bool $inCrate
     */
    public function setInCrate($inCrate = true) {
    ...
    public function addCrateParticle(CrateBlock $crateBlock) {
        $particle = new CrateFloatingText($crateBlock->getCrate(), $crateBlock->add(0.5, 0.5, 0.5), Utils::translateColors("{AQUA}{BOLD}Bạn Đang Có {YELLOW}{$this->getCrateKey($crateBlock->getCrate()->getIdentifier())} {AQUA}Chìa Khóa"));
    ...
    public function updateCrateParticles() {
        foreach($this->crateParticles as $particle) {
            $particle->setTitle(Utils::translateColors("{AQUA}{BOLD}Bạn Đang Có {YELLOW}{$this->getCrateKey($particle->getCrate()->getIdentifier())} {AQUA}Chìa Khóa"));
